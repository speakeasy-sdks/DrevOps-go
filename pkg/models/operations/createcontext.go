...
func (e *CreateContextRequestBodyOwner2TypeEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "organization":
		*e = CreateContextRequestBodyOwner2TypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateContextRequestBodyOwner2TypeEnum: %s", s)
	}
}
...
func (e *CreateContextRequestBodyOwner1TypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "account":
		fallthrough
	case "organization":
		*e = CreateContextRequestBodyOwner1TypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateContextRequestBodyOwner1TypeEnum: %s", s)
	}
}

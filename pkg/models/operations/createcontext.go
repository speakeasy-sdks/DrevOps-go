...
type CreateContextRequestBodyOwner2Type string

const (
	CreateContextRequestBodyOwner2TypeOrganization CreateContextRequestBodyOwner2Type = "organization"
)

func (e CreateContextRequestBodyOwner2Type) ToPointer() *CreateContextRequestBodyOwner2Type {
	return &e
}

func (e *CreateContextRequestBodyOwner2Type) UnmarshalJSON(data []byte) error {
	var v string
	...
	switch v {
	case "organization":
		*e = CreateContextRequestBodyOwner2Type(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateContextRequestBodyOwner2Type: %v", v)
	}
}
...
type CreateContextRequestBodyOwner2 struct {
	...
	Type *CreateContextRequestBodyOwner2Type `json:"type,omitempty"`
}
...
type CreateContextRequestBodyOwner1Type string

const (
	CreateContextRequestBodyOwner1TypeAccount      CreateContextRequestBodyOwner1Type = "account"
	CreateContextRequestBodyOwner1TypeOrganization CreateContextRequestBodyOwner1Type = "organization"
)

func (e CreateContextRequestBodyOwner1Type) ToPointer() *CreateContextRequestBodyOwner1Type {
	return &e
}

func (e *CreateContextRequestBodyOwner1Type) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "account":
		fallthrough
	case "organization":
		*e = CreateContextRequestBodyOwner1Type(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateContextRequestBodyOwner1Type: %v", v)
	}
}
...
type CreateContextRequestBodyOwner1 struct {
	...
	Type *CreateContextRequestBodyOwner1Type `json:"type,omitempty"`
}

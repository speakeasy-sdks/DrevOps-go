...
func (e *CreateScheduleCreateScheduleParametersAttributionActorEnum) UnmarshalJSON(data []byte) error {
	...
	case "current":
		fallthrough
	case "system":
		*e = CreateScheduleCreateScheduleParametersAttributionActorEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateScheduleCreateScheduleParametersAttributionActorEnum: %v", v)
	}
}
...
func (e *CreateScheduleCreateScheduleParametersTimetable2DaysOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "WED":
		fallthrough
	case "FRI":
		*e = CreateScheduleCreateScheduleParametersTimetable2DaysOfWeekEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateScheduleCreateScheduleParametersTimetable2DaysOfWeekEnum: %v", v)
	}
}
...
func (e *CreateScheduleCreateScheduleParametersTimetable2MonthsEnum) UnmarshalJSON(data []byte) error {
	...
	case "JAN":
		fallthrough
	case "JUL":
		*e = CreateScheduleCreateScheduleParametersTimetable2MonthsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateScheduleCreateScheduleParametersTimetable2MonthsEnum: %v", v)
	}
}
...
func (e *CreateScheduleCreateScheduleParametersTimetable1DaysOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "WED":
		fallthrough
	case "FRI":
		*e = CreateScheduleCreateScheduleParametersTimetable1DaysOfWeekEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateScheduleCreateScheduleParametersTimetable1DaysOfWeekEnum: %v", v)
	}
}
...
func (e *CreateScheduleCreateScheduleParametersTimetable1MonthsEnum) UnmarshalJSON(data []byte) error {
	...
	case "JAN":
		fallthrough
	case "JUL":
		*e = CreateScheduleCreateScheduleParametersTimetable1MonthsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateScheduleCreateScheduleParametersTimetable1MonthsEnum: %v", v)
	}
}
...
func (e *CreateScheduleScheduleTimetable2DaysOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "WED":
		fallthrough
	case "FRI":
		*e = CreateScheduleScheduleTimetable2DaysOfWeekEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateScheduleScheduleTimetable2DaysOfWeekEnum: %v", v)
	}
}
...
func (e *CreateScheduleScheduleTimetable2MonthsEnum) UnmarshalJSON(data []byte) error {
	...
	case "JAN":
		fallthrough
	case "JUL":
		*e = CreateScheduleScheduleTimetable2MonthsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateScheduleScheduleTimetable2MonthsEnum: %v", v)
	}
}
...
func (e *CreateScheduleScheduleTimetable1DaysOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "WED":
		fallthrough
	case "FRI":
		*e = CreateScheduleScheduleTimetable1DaysOfWeekEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateScheduleScheduleTimetable1DaysOfWeekEnum: %v", v)
	}
}
...
func (e *CreateScheduleScheduleTimetable1MonthsEnum) UnmarshalJSON(data []byte) error {
	...
	case "JAN":
		fallthrough
	case "JUL":
		*e = CreateScheduleScheduleTimetable1MonthsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateScheduleScheduleTimetable1MonthsEnum: %v", v)
	}
}

...
func (e *ListSchedulesForProject200ApplicationJSONScheduleTimetable2DaysOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "WED":
		fallthrough
	case "FRI":
		*e = ListSchedulesForProject200ApplicationJSONScheduleTimetable2DaysOfWeekEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListSchedulesForProject200ApplicationJSONScheduleTimetable2DaysOfWeekEnum: %v", v)
	}
}
...
func (e *ListSchedulesForProject200ApplicationJSONScheduleTimetable2MonthsEnum) UnmarshalJSON(data []byte) error {
	...
	case "JAN":
		fallthrough
	case "JUL":
		*e = ListSchedulesForProject200ApplicationJSONScheduleTimetable2MonthsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListSchedulesForProject200ApplicationJSONScheduleTimetable2MonthsEnum: %v", v)
	}
}
...
func (e *ListSchedulesForProject200ApplicationJSONScheduleTimetable1DaysOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "WED":
		fallthrough
	case "FRI":
		*e = ListSchedulesForProject200ApplicationJSONScheduleTimetable1DaysOfWeekEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListSchedulesForProject200ApplicationJSONScheduleTimetable1DaysOfWeekEnum: %v", v)
	}
}
...
func (e *ListSchedulesForProject200ApplicationJSONScheduleTimetable1MonthsEnum) UnmarshalJSON(data []byte) error {
	...
	case "JAN":
		fallthrough
	case "JUL":
		*e = ListSchedulesForProject200ApplicationJSONScheduleTimetable1MonthsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListSchedulesForProject200ApplicationJSONScheduleTimetable1MonthsEnum: %v", v)
	}
}

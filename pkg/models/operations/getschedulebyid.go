...
func (e *GetScheduleByIDScheduleTimetable2DaysOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "WED":
		fallthrough
	case "FRI":
		*e = GetScheduleByIDScheduleTimetable2DaysOfWeekEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetScheduleByIDScheduleTimetable2DaysOfWeekEnum: %s", s)
	}
}
...
func (e *GetScheduleByIDScheduleTimetable2MonthsEnum) UnmarshalJSON(data []byte) error {
	...
	case "JAN":
		fallthrough
	case "JUL":
		*e = GetScheduleByIDScheduleTimetable2MonthsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetScheduleByIDScheduleTimetable2MonthsEnum: %s", s)
	}
}
...
func (e *GetScheduleByIDScheduleTimetable1DaysOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "WED":
		fallthrough
	case "FRI":
		*e = GetScheduleByIDScheduleTimetable1DaysOfWeekEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetScheduleByIDScheduleTimetable1DaysOfWeekEnum: %s", s)
	}
}
...
func (e *GetScheduleByIDScheduleTimetable1MonthsEnum) UnmarshalJSON(data []byte) error {
	...
	case "JAN":
		fallthrough
	case "JUL":
		*e = GetScheduleByIDScheduleTimetable1MonthsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetScheduleByIDScheduleTimetable1MonthsEnum: %s", s)
	}
}

...
func (e GetJobDetailsJobDetailsStatusEnum) ToPointer() *GetJobDetailsJobDetailsStatusEnum {
	return &e
}

func (e *GetJobDetailsJobDetailsStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "canceled":
		fallthrough
	case "unauthorized":
		*e = GetJobDetailsJobDetailsStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetJobDetailsJobDetailsStatusEnum: %s", s)
	}
}

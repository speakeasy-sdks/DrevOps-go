...
func (e *ListMyPipelinesPipelineListResponsePipelineErrorsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "other":
		fallthrough
	case "plan":
		*e = ListMyPipelinesPipelineListResponsePipelineErrorsTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListMyPipelinesPipelineListResponsePipelineErrorsTypeEnum: %s", s)
	}
}
...
func (e *ListMyPipelinesPipelineListResponsePipelineStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "setup":
		fallthrough
	case "pending":
		*e = ListMyPipelinesPipelineListResponsePipelineStateEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListMyPipelinesPipelineListResponsePipelineStateEnum: %s", s)
	}
}
...
func (e *ListMyPipelinesPipelineListResponsePipelineTriggerTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "api":
		fallthrough
	case "webhook":
		*e = ListMyPipelinesPipelineListResponsePipelineTriggerTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListMyPipelinesPipelineListResponsePipelineTriggerTypeEnum: %s", s)
	}
}

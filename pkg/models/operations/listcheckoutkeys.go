...
func (e *ListCheckoutKeysCheckoutKeyListResponseCheckoutKeyCheckoutKeyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "github-user-key":
		*e = ListCheckoutKeysCheckoutKeyListResponseCheckoutKeyCheckoutKeyTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListCheckoutKeysCheckoutKeyListResponseCheckoutKeyCheckoutKeyTypeEnum: %s", s)
	}
}

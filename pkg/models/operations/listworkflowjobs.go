...
func (e *ListWorkflowJobsWorkflowJobListResponseJobStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "canceled":
		fallthrough
	case "unauthorized":
		*e = ListWorkflowJobsWorkflowJobListResponseJobStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListWorkflowJobsWorkflowJobListResponseJobStatusEnum: %v", v)
	}
}
...
func (e *ListWorkflowJobsWorkflowJobListResponseJobTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "build":
		fallthrough
	case "approval":
		*e = ListWorkflowJobsWorkflowJobListResponseJobTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListWorkflowJobsWorkflowJobListResponseJobTypeEnum: %v", v)
	}
}

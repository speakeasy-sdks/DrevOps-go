...
type GetWebhookByIDWebhookEvents string

const (
	GetWebhookByIDWebhookEventsWorkflowCompleted GetWebhookByIDWebhookEvents = "workflow-completed"
	GetWebhookByIDWebhookEventsJobCompleted      GetWebhookByIDWebhookEvents = "job-completed"
)

func (e GetWebhookByIDWebhookEvents) ToPointer() *GetWebhookByIDWebhookEvents {
	return &e
}

func (e *GetWebhookByIDWebhookEvents) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "workflow-completed":
		fallthrough
	case "job-completed":
		*e = GetWebhookByIDWebhookEvents(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetWebhookByIDWebhookEvents: %v", v)
	}
}
...
type GetWebhookByIDWebhook struct {
	...
	Events []GetWebhookByIDWebhookEvents `json:"events"`

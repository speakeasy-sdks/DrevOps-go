...
func (e *GetPipelineByIDPipelineErrorsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "other":
		fallthrough
	case "plan":
		*e = GetPipelineByIDPipelineErrorsTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPipelineByIDPipelineErrorsTypeEnum: %v", v)
	}
}
...
func (e *GetPipelineByIDPipelineStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "setup":
		fallthrough
	case "pending":
		*e = GetPipelineByIDPipelineStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPipelineByIDPipelineStateEnum: %v", v)
	}
}
...
func (e *GetPipelineByIDPipelineTriggerTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "api":
		fallthrough
	case "webhook":
		*e = GetPipelineByIDPipelineTriggerTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPipelineByIDPipelineTriggerTypeEnum: %v", v)
	}
}

...
func (e GetJobTimeseriesGranularityEnum) ToPointer() *GetJobTimeseriesGranularityEnum {
	return &e
}

func (e *GetJobTimeseriesGranularityEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "daily":
		fallthrough
	case "hourly":
		*e = GetJobTimeseriesGranularityEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetJobTimeseriesGranularityEnum: %v", v)
	}
}

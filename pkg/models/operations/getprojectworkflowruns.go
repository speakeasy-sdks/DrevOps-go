...
func (e *GetProjectWorkflowRuns200ApplicationJSONItemsStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "canceled":
		fallthrough
	case "unauthorized":
		*e = GetProjectWorkflowRuns200ApplicationJSONItemsStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetProjectWorkflowRuns200ApplicationJSONItemsStatusEnum: %v", v)
	}
}

...
func (e *UpdateWebhookRequestBodyEventsEnum) UnmarshalJSON(data []byte) error {
	...
	case "workflow-completed":
		fallthrough
	case "job-completed":
		*e = UpdateWebhookRequestBodyEventsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateWebhookRequestBodyEventsEnum: %s", s)
	}
}
...
func (e *UpdateWebhookWebhookEventsEnum) UnmarshalJSON(data []byte) error {
	...
	case "workflow-completed":
		fallthrough
	case "job-completed":
		*e = UpdateWebhookWebhookEventsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateWebhookWebhookEventsEnum: %s", s)
	}
}

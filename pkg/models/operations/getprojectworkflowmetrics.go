...
// GetProjectWorkflowMetricsReportingWindowEnum - The time window used to calculate summary metrics.
...
func (e GetProjectWorkflowMetricsReportingWindowEnum) ToPointer() *GetProjectWorkflowMetricsReportingWindowEnum {
	return &e
}

func (e *GetProjectWorkflowMetricsReportingWindowEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "last-30-days":
		fallthrough
	case "last-60-days":
		*e = GetProjectWorkflowMetricsReportingWindowEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetProjectWorkflowMetricsReportingWindowEnum: %v", v)
	}
}

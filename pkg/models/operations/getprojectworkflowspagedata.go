...
type GetProjectWorkflowsPageDataRequest struct {
	...
	Branches *GetProjectWorkflowsPageDataBranches `queryParam:"style=form,explode=true,name=branches"`
	...
	WorkflowNames *GetProjectWorkflowsPageDataWorkflowNames `queryParam:"style=form,explode=true,name=workflow-names"`
}

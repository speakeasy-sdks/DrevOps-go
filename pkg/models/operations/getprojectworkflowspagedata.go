...
// GetProjectWorkflowsPageDataReportingWindowEnum - The time window used to calculate summary metrics.
...
func (e GetProjectWorkflowsPageDataReportingWindowEnum) ToPointer() *GetProjectWorkflowsPageDataReportingWindowEnum {
	return &e
}

func (e *GetProjectWorkflowsPageDataReportingWindowEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "last-30-days":
		fallthrough
	case "last-60-days":
		*e = GetProjectWorkflowsPageDataReportingWindowEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetProjectWorkflowsPageDataReportingWindowEnum: %s", s)
	}
}

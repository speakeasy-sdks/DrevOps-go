...
func (e *UpdateScheduleUpdateScheduleParametersAttributionActorEnum) UnmarshalJSON(data []byte) error {
	...
	case "current":
		fallthrough
	case "system":
		*e = UpdateScheduleUpdateScheduleParametersAttributionActorEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateScheduleUpdateScheduleParametersAttributionActorEnum: %s", s)
	}
}
...
func (e *UpdateScheduleUpdateScheduleParametersTimetableDaysOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "WED":
		fallthrough
	case "FRI":
		*e = UpdateScheduleUpdateScheduleParametersTimetableDaysOfWeekEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateScheduleUpdateScheduleParametersTimetableDaysOfWeekEnum: %s", s)
	}
}
...
func (e *UpdateScheduleUpdateScheduleParametersTimetableMonthsEnum) UnmarshalJSON(data []byte) error {
	...
	case "JAN":
		fallthrough
	case "JUL":
		*e = UpdateScheduleUpdateScheduleParametersTimetableMonthsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateScheduleUpdateScheduleParametersTimetableMonthsEnum: %s", s)
	}
}
...
func (e *UpdateScheduleScheduleTimetable2DaysOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "WED":
		fallthrough
	case "FRI":
		*e = UpdateScheduleScheduleTimetable2DaysOfWeekEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateScheduleScheduleTimetable2DaysOfWeekEnum: %s", s)
	}
}
...
func (e *UpdateScheduleScheduleTimetable2MonthsEnum) UnmarshalJSON(data []byte) error {
	...
	case "JAN":
		fallthrough
	case "JUL":
		*e = UpdateScheduleScheduleTimetable2MonthsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateScheduleScheduleTimetable2MonthsEnum: %s", s)
	}
}
...
func (e *UpdateScheduleScheduleTimetable1DaysOfWeekEnum) UnmarshalJSON(data []byte) error {
	...
	case "WED":
		fallthrough
	case "FRI":
		*e = UpdateScheduleScheduleTimetable1DaysOfWeekEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateScheduleScheduleTimetable1DaysOfWeekEnum: %s", s)
	}
}
...
func (e *UpdateScheduleScheduleTimetable1MonthsEnum) UnmarshalJSON(data []byte) error {
	...
	case "JAN":
		fallthrough
	case "JUL":
		*e = UpdateScheduleScheduleTimetable1MonthsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateScheduleScheduleTimetable1MonthsEnum: %s", s)
	}
}

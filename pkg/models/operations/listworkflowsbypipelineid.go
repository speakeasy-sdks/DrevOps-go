...
func (e *ListWorkflowsByPipelineIDWorkflowListResponseWorkflowStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "canceled":
		fallthrough
	case "unauthorized":
		*e = ListWorkflowsByPipelineIDWorkflowListResponseWorkflowStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListWorkflowsByPipelineIDWorkflowListResponseWorkflowStatusEnum: %s", s)
	}
}
...
func (e *ListWorkflowsByPipelineIDWorkflowListResponseWorkflowTagEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "setup":
		*e = ListWorkflowsByPipelineIDWorkflowListResponseWorkflowTagEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListWorkflowsByPipelineIDWorkflowListResponseWorkflowTagEnum: %s", s)
	}
}

...
func (e *GetPipelineByNumberPipelineErrorsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "other":
		fallthrough
	case "plan":
		*e = GetPipelineByNumberPipelineErrorsTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPipelineByNumberPipelineErrorsTypeEnum: %v", v)
	}
}
...
func (e *GetPipelineByNumberPipelineStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "setup":
		fallthrough
	case "pending":
		*e = GetPipelineByNumberPipelineStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPipelineByNumberPipelineStateEnum: %v", v)
	}
}
...
func (e *GetPipelineByNumberPipelineTriggerTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "api":
		fallthrough
	case "webhook":
		*e = GetPipelineByNumberPipelineTriggerTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPipelineByNumberPipelineTriggerTypeEnum: %v", v)
	}
}

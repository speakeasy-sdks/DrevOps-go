...
func (e GetProjectBySlugProjectVcsInfoProviderEnum) ToPointer() *GetProjectBySlugProjectVcsInfoProviderEnum {
	return &e
}

func (e *GetProjectBySlugProjectVcsInfoProviderEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "CircleCI":
		fallthrough
	case "GitHub":
		*e = GetProjectBySlugProjectVcsInfoProviderEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetProjectBySlugProjectVcsInfoProviderEnum: %s", s)
	}
}

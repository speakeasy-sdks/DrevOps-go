...
func (e ListContextsOwnerType) ToPointer() *ListContextsOwnerType {
	return &e
}

func (e *ListContextsOwnerType) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "account":
		fallthrough
	case "organization":
		*e = ListContextsOwnerType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListContextsOwnerType: %v", v)
	}
}
...
type ListContextsRequest struct {
	...
	OwnerType *ListContextsOwnerType `queryParam:"style=form,explode=true,name=owner-type"`

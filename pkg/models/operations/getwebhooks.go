...
func (e *GetWebhooksScopeTypeEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "project":
		*e = GetWebhooksScopeTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetWebhooksScopeTypeEnum: %s", s)
	}
}
...
func (e *GetWebhooks200ApplicationJSONWebhookEventsEnum) UnmarshalJSON(data []byte) error {
	...
	case "workflow-completed":
		fallthrough
	case "job-completed":
		*e = GetWebhooks200ApplicationJSONWebhookEventsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetWebhooks200ApplicationJSONWebhookEventsEnum: %s", s)
	}
}

...
func (e *ListPipelinesPipelineListResponsePipelineErrorsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "other":
		fallthrough
	case "plan":
		*e = ListPipelinesPipelineListResponsePipelineErrorsTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListPipelinesPipelineListResponsePipelineErrorsTypeEnum: %s", s)
	}
}
...
func (e *ListPipelinesPipelineListResponsePipelineStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "setup":
		fallthrough
	case "pending":
		*e = ListPipelinesPipelineListResponsePipelineStateEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListPipelinesPipelineListResponsePipelineStateEnum: %s", s)
	}
}
...
func (e *ListPipelinesPipelineListResponsePipelineTriggerTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "api":
		fallthrough
	case "webhook":
		*e = ListPipelinesPipelineListResponsePipelineTriggerTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListPipelinesPipelineListResponsePipelineTriggerTypeEnum: %s", s)
	}
}

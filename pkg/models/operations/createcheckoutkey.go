...
func (e *CreateCheckoutKeyCheckoutKeyInputCheckoutKeyInputTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "user-key":
		fallthrough
	case "deploy-key":
		*e = CreateCheckoutKeyCheckoutKeyInputCheckoutKeyInputTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCheckoutKeyCheckoutKeyInputCheckoutKeyInputTypeEnum: %v", v)
	}
}
...
func (e *CreateCheckoutKeyCheckoutKeyCheckoutKeyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "github-user-key":
		*e = CreateCheckoutKeyCheckoutKeyCheckoutKeyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCheckoutKeyCheckoutKeyCheckoutKeyTypeEnum: %v", v)
	}
}

...
// GetProjectWorkflowJobMetricsReportingWindow - The time window used to calculate summary metrics.
...
func (e GetProjectWorkflowJobMetricsReportingWindow) ToPointer() *GetProjectWorkflowJobMetricsReportingWindow {
	return &e
}

func (e *GetProjectWorkflowJobMetricsReportingWindow) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "last-30-days":
		fallthrough
	case "last-60-days":
		*e = GetProjectWorkflowJobMetricsReportingWindow(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetProjectWorkflowJobMetricsReportingWindow: %v", v)
	}
}
...
type GetProjectWorkflowJobMetricsRequest struct {
	...
	ReportingWindow *GetProjectWorkflowJobMetricsReportingWindow `queryParam:"style=form,explode=true,name=reporting-window"`

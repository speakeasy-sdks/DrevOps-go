...
func main() {
    ...
    res, err := s.Schedule.CreateSchedule(ctx, req)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Schedule.DeleteScheduleByID(ctx, req)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Schedule.GetScheduleByID(ctx, req)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Schedule.ListSchedulesForProject(ctx, req)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Schedule.UpdateSchedule(ctx, req)
    if err != nil {
        log.Fatal(err)
    }
